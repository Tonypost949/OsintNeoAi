...
file_path = r'C:\Users\Amd949609\.gemini\antigravity-cli\brain\e0259c57-0b03-45f8-956f-927ea22d1195\.system_generated\steps\5980\content.md'
with open(file_path, 'r', encoding='utf-8', errors='ignore') as f:
    text = f.read()

# Extract all markdown/HTML links [Title](URL) or href="URL"
...
print(f"Total extracted OC Gov links: {len(all_links)}")
