...
KNOWN_CLIS = [
    ...
    {"name": "GitHub CLI (gh)", "cmd": "gh", "category": "Version Control", "test": "gh --version", "example": "gh auth status"},
...
if __name__ == "__main__":
    port = 5051
    print(f"\n🚀 CLIDiscover Google Cloud Edition active at http://127.0.0.1:{port}\n")
