...
```mermaid
graph TD
    P1["Pillar 1: US DOJ / FBI Criminal Convictions<br>(Andrew Do Guilty Plea / Peter Pham Fugitive Warrant)"]
    P2["Pillar 2: CA Water Board GeoTracker T10000018579<br>(490 ppb Cr VI / 49x EPA Limit)"]
    P3["Pillar 3: FBI/EPA Cybersecurity Alert PSA I-073026-PSA<br>(Rockwell PLC Telemetry Remote Disabling)"]
    P4["Pillar 4: SBA FOIA Database vs. OC Assessor Property Records<br>(135 Out-of-State Shell LLCs Purchasing OC Assets)"]
    P5["Pillar 5: CA State Controller Unclaimed Property Database<br>(Property ID 1024456136 / $3.88M Pham Trust)"]
    P6["Pillar 6: Public IRS Form 990 Disclosures<br>(Mercy House Board Member PPP Self-Dealing: $6.49M)"]
    P7["Pillar 7: HUD PIT Count vs. CDSS Public Foster Records<br>(29,300 Unaccounted Child Gap Arithmetic)"]
```
