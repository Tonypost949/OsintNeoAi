...
TABLE_ID = "gmail_govt_responses_hits"
FILE_PATH = "gmail_govt_responses_hits.json"
...
def main():
    ...
    try:
        ...
        dataset.default_table_expiration_ms = 59 * 24 * 60 * 60 * 1000
    ...
    for msg in data:
        rows_to_insert.append({
            ...
            "query_match": "inbox_govt_responses",
    ...
    print("[+] SUCCESS! All Govt & Response emails have been loaded into BigQuery.")
