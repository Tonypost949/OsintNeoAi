<div align="center">
  ...
  <p align="center">
    <a href="https://github.com/Tonypost949/OsintNeoAi/actions"><img src="https://img.shields.io/badge/BUILD-PASSING-00ffc8?style=for-the-badge&logo=githubactions&logoColor=black" alt="Build Status" /></a>
    <a href="https://osintneoai-app-949.azurewebsites.net/gods_eye_view.html"><img src="https://img.shields.io/badge/3D_GLOBE-OPERATIONAL-00d4ff?style=for-the-badge&logo=cesium&logoColor=white" alt="3D Tactical Globe" /></a>
    <a href="https://osintneoai-app-949.azurewebsites.net/syncfusion"><img src="https://img.shields.io/badge/SYNCFUSION_GRID-ENTERPRISE-7928CA?style=for-the-badge&logo=microsoftazure&logoColor=white" alt="Syncfusion" /></a>
    <a href="https://cloud.google.com/bigquery"><img src="https://img.shields.io/badge/BIGQUERY-GRAPH_ACTIVE-4285F4?style=for-the-badge&logo=googlecloud&logoColor=white" alt="BigQuery" /></a>
    <a href="https://github.com/Tonypost949/OsintNeoAi/blob/main/LICENSE"><img src="https://img.shields.io/badge/LICENSE-MIT-yellow?style=for-the-badge" alt="License" /></a>
  </p>
...
```mermaid
flowchart LR
    subgraph INGESTION["📥 Multi-Vector Ingestion"]
        A1["Google Photos / Drive"]
        A2["Microsoft OneDrive"]
        A3["Municipal & State SOS"]
        A4["CalEPA GeoTracker"]
    end

    subgraph CORE["🧠 OSINTNeoAI-Core"]
        B1["Neural OCR & Entity Extraction"]
        B2["Aegis Correlation Engine"]
        B3["Graph Matrix Builder"]
    end

    subgraph STORAGE["💾 Enterprise Graph & Storage"]
        C1[("Google BigQuery Engine")]
        C2[("GraphDB / GeoJSON")]
        C3[("Syncfusion Grid")]
    end

    subgraph INTERFACE["👁️ Cockpits & Visualizers"]
        D1["God's Eye 3D Tactical Globe"]
        D2["Task Board & Forensic Dossiers"]
        D3["Whistleblower Matrix"]
    end
    ...
    classDef glow fill:#0a1128,stroke:#00d4ff,stroke-width:2px,color:#fff;
    class INGESTION,CORE,STORAGE,INTERFACE glow;
```
